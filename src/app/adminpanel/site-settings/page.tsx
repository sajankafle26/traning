...
const SiteSettingsAdmin = () => {
    ...
    return (
        <div className="space-y-12">
            <div className="space-y-1 border-b border-slate-200 pb-8">
            ...
            <form onSubmit={handleSave} className="grid lg:grid-cols-2 gap-12 animate-in fade-in duration-500">
                <div className="bg-white border border-slate-200 rounded-[3rem] p-10 space-y-8">
                    <div className="space-y-4">
                        <h2 className="text-xl font-bold text-slate-900">Contact Information</h2>
                        <p className="text-slate-500 text-sm">Primary contact channels used in footer and support sections.</p>
                    </div>
                ...
                <div className="space-y-8 h-full flex flex-col">
                    <div className="bg-white border border-slate-200 rounded-[3rem] p-10 space-y-8 flex-1">
                        <div className="space-y-4">
                            <h2 className="text-xl font-bold text-slate-900">Social Media Links</h2>
                            <p className="text-slate-500 text-sm">Full URLs to your social profiles.</p>
                        </div>
                    ...
                    <button
                        type="submit"
                        disabled={isSaving}
                        className="w-full bg-[#00548B] hover:bg-[#004381] text-white py-6 rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#00548B]/20 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                    >
