...
const Blog = () => {
  ...
  return (
    <section id="blog" className="py-32 px-6 relative overflow-hidden bg-[#00548B]">
      ...
      <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-blue-400/10 blur-[120px] rounded-full" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-white/5 blur-[100px] rounded-full" />
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-24">
          ...
          <a
            href="/blog"
            className="hidden lg:flex items-center gap-3 bg-white text-[#00548B] px-10 py-5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl hover:bg-transparent hover:text-white hover:border-white transition-all active:scale-95 no-underline border-2 border-transparent"
          >
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-[18rem] bg-white/10 rounded-[3rem] animate-pulse border border-white/10"></div>
            ))}
          </div>
        ) : (
          <Swiper
              ...
              <SwiperSlide key={blog.id} className="h-auto">
                <a href={blog.link} className="group block focus:outline-none h-full no-underline">
                  <div className="relative group h-full">
                    {/* Visual Stack Layers */}
                    <div className="absolute inset-4 bg-white/5 rounded-[3.5rem] rotate-2 scale-[1.02] transition-all duration-700 group-hover:rotate-6" />
                    ...
                    <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-[3.5rem] overflow-hidden transition-all duration-700 group-hover:-translate-y-4 shadow-[0_64px_128px_-32px_rgba(0,0,0,0.5)] flex flex-col h-full">
                      <div className="relative aspect-[16/10] overflow-hidden">
                        ...
                        <div className="absolute top-6 left-6">
                          <div className="bg-[#00548B]/80 backdrop-blur-md text-white text-[8px] font-black uppercase tracking-[0.2em] px-5 py-2.5 rounded-full border border-white/20">
                      ...
                      <div className="p-10 flex flex-col flex-grow space-y-2">
                        ...
                        <h3 className=" font-black text-white leading-tight group-hover:text-[#00548B] transition-colors line-clamp-2 tracking-tight">
                          {blog.title}
                        </h3>

                        <p className="text-white/60 font-medium text-sm leading-relaxed line-clamp-3">
                          {blog.excerpt}
                        </p>

                        <div className="mt-auto pt-6 flex items-center gap-3 text-white text-[10px] font-black uppercase tracking-[0.25em] group-hover:text-[#00548B] group-hover:translate-x-3 transition-all duration-500">
