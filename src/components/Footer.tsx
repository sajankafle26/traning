...
const Footer = () => {
  ...
  return (
    <footer aria-label="Site footer" ref={sectionRef} className="relative bg-[#00548B] text-white pt-16 md:pt-24 pb-28 md:pb-10 px-5 md:px-6 overflow-hidden">
      ...
      {/* Payment Methods */}
      <div className="relative z-10 max-w-[1400px] px-4 mx-auto py-8 md:py-10 border-b border-white/10">
      ...
      {/* Footer tail */}
      <div className="relative z-10 max-w-[1400px] px-4 mx-auto pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-blue-100/50">
