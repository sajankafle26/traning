...
const Footer = () => {
  ...
  return (
    <footer aria-label="Site footer" ref={sectionRef} className="relative bg-[#00548B] text-white pt-16 md:pt-24 pb-28 md:pb-10 px-5 md:px-6 overflow-hidden">
      ...
      {/* Google Maps */}
      <div className="relative z-10 max-w-[1200px] mx-auto mb-12 md:mb-16">
      ...
      {/* Main Footer Grid */}
      <div className="relative z-10 max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 border-b border-white/10 pb-12 md:pb-16">
        {/* Company Info */}
